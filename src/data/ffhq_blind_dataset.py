...
from src.data import gaussian_kernels as gaussian_kernels
from src.data.transforms import augment
from src.data.data_util import paths_from_folder, brush_stroke_mask, random_ff_mask
...
class FFHQBlindDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if self.use_motion_kernel:
            ...
            motion_kernel_path = opt.get('motion_kernel_path', 'src/data/motion-blur-kernels-32.pth')
